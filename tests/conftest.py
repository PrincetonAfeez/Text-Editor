...
_fake_curses.raw = lambda: None  # type: ignore[attr-defined]
_fake_curses.cbreak = lambda: None  # type: ignore[attr-defined]
_fake_curses.noecho = lambda: None  # type: ignore[attr-defined]
_fake_curses.curs_set = lambda _visibility: None  # type: ignore[attr-defined]
_fake_curses.use_default_colors = lambda: None  # type: ignore[attr-defined]
_fake_curses.wrapper = lambda func: func(_fake_curses)  # type: ignore[attr-defined]
